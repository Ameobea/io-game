...
use super::entities::{create_player_shape_handle, EntityType, BEAM_SHAPE_HANDLE};
use super::world::{EntityHandles, PhysicsWorldInner, COLLIDER_MARGIN, DEFAULT_PLAYER_SIZE};
use super::Movement;
...
impl PhysicsWorld {
    ...
    pub fn apply_diff<'a>(
        ...
        let EntityHandles {
            ...
            collider_handle,
            ref mut beam_handle,
        } = match uuid_map.get_mut(&diff.id) {
            Some(handle) => handle,
            None => {
                println!(
